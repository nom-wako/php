    ...
    <div class="result__content">
      <div class="result-cards">
        <div class="result-card">
          <div class="result-card__img-wrapper"><img src="img/<?php echo $tokyo['img'] ?>" alt="国旗" class="result-card__img"></div>
        ...
        <div class="result-card">
          <div class="result-card__img-wrapper"><img src="img/<?php echo $comparison['img'] ?>" alt="国旗" class="result-card__img"></div>
          <div class="result-card__body">
